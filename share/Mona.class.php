...
class Mona {
	...
	private $_google_url = "http://ajax.googleapis.com/ajax/services/search/images?v=1.0&key=ABQIAAAAq4AIuvYeP4AL8FNxqeSM6BS1_wxKxGdp2RzRaADWaiSLCsSD_BRB9crcfrmh0Bj8s6TsAcqGepcWcg&userip=213.93.210.241&q=woman%20face&imgtype=face&rsz=8&safe=off&start=";
	...
	public function __construct() {
		...
		$this->_json_result = @file_get_contents($this->_google_url . rand(1,24));
		$this->_prepare_faces();
	}
